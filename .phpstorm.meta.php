...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.stores.database.lock_table' => 'string',
            ...
            'filesystems.links.C:\xampp\htdocs\manpro-app\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\manpro-app\\public\\storage','logging.default','logging.deprecations.channel',
...
'services.telegram-bot-api.token','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'sanctum.csrf-cookie','api.guest.complaint.store','api.dashboard.stats','api.notifications.index','api.notifications.read.all',
'api.notifications.read.one','api.buildings.index','api.buildings.store','api.buildings.show','api.buildings.update',
'api.buildings.destroy','api.floors.index','api.floors.list','api.floors.store','api.floors.show',
'api.floors.update','api.floors.destroy','api.rooms.index','api.rooms.list','api.rooms.store',
'api.rooms.show','api.rooms.update','api.rooms.destroy','api.assets.index','api.assets.store',
'api.assets.show','api.assets.update','api.assets.stock_out','api.assets.list_for_dropdown','api.assets.destroy',
'api.asset_categories.index','api.asset_categories.store','api.asset_categories.update','api.asset_categories.destroy','api.assets.by_category',
'api.maintenances.index','api.maintenances.store','api.maintenances.show','api.maintenances.update','api.maintenances.destroy',
'api.task_types.index','api.task_types.store','api.task_types.show','api.task_types.update','api.task_types.destroy',
'api.task_types.by-department','api.users.index','api.users.store','api.users.show','api.users.update',
'api.users.destroy','api.stock.index','api.stock.update','api.packing_lists.index','api.packing_lists.store',
'api.packing_lists.get_assets','api.complaints.index','api.complaints.store','api.complaints.show','api.complaints.destroy',
'api.complaints.convert','api.tasks.store','api.tasks.review_list_data','api.tasks.submit_review','api.tasks.in_progress_data',
'api.tasks.active_data','api.tasks.available_data','api.tasks.claim','api.tasks.my_history_data','api.tasks.history_data',
'api.tasks.my_tasks_data','api.tasks.show_data','api.tasks.completed_history_data','api.tasks.reports.store','api.asset_history.index','welcome','guest.complaint.create','dashboard','profile.edit',
'profile.update','profile.destroy','profile.signature.update','packing_lists.pdf','packing_lists.index',
'stock.index','asset_history.index','complaints.index','complaints.create','complaints.show',
'tasks.monitoring','history.tasks','export.index','export.assets','export.task_history',
'master.buildings.index','master.buildings.create','master.buildings.show','master.buildings.edit','master.floors.index',
'master.floors.create','master.floors.show','master.floors.edit','master.rooms.index','master.rooms.create',
'master.rooms.show','master.rooms.edit','master.task_types.index','master.task_types.create','master.task_types.show',
'master.task_types.edit','master.assets.index','master.assets.create','master.assets.show','master.assets.edit',
'master.assets.master.assets.assets.by_category','master.asset_categories.index','master.asset_categories.create','master.asset_categories.show','master.asset_categories.edit',
'master.maintenances.index','master.maintenances.create','master.maintenances.show','master.maintenances.edit','users.index',
'users.create','users.show','users.edit','tasks.create','tasks.review_list',
'tasks.available','tasks.my_history','tasks.my_tasks','tasks.completed_history','tasks.show',
'notifications.index','notifications.markAllAsRead','notifications.markAsRead','register',
...
'auth.verify-email','backend.asset_history.index','backend.complaints.create','backend.complaints.guest-form','backend.complaints.index',
'backend.complaints.show','backend.dashboard','backend.export.index','backend.master.asset_categories.create','backend.master.asset_categories.edit',
'backend.master.asset_categories.index','backend.master.assets.category_detail','backend.master.assets.create','backend.master.assets.edit','backend.master.assets.index',
'backend.master.assets.show','backend.master.buildings.create','backend.master.buildings.edit','backend.master.buildings.index','backend.master.buildings.show',
'backend.master.floors.create','backend.master.floors.edit','backend.master.floors.index','backend.master.floors.show','backend.master.maintenances.create',
'backend.master.maintenances.edit','backend.master.maintenances.index','backend.master.maintenances.show','backend.master.rooms.create','backend.master.rooms.edit',
'backend.master.rooms.index','backend.master.rooms.show','backend.master.task_types.create','backend.master.task_types.edit','backend.master.task_types.index',
'backend.master.task_types.show','backend.packing_lists.index','backend.packing_lists.pdf','backend.profile.edit','backend.stock.index',
'backend.tasks.available','backend.tasks.completed_history','backend.tasks.create','backend.tasks.history','backend.tasks.monitoring',
'backend.tasks.my_history','backend.tasks.my_tasks','backend.tasks.review_list','backend.tasks.show','backend.users.create',
'backend.users.edit','backend.users.index','backend.users.show','components.application-logo','components.auth-session-status',
...
'components.text-input','layouts.app','layouts.guest','layouts.navigation','notifications.index',
...
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.xampp.htdocs.manpro-app.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','actions.accept','actions.action','actions.actions',
...
'VITE_APP_NAME','TELEGRAM_BOT_TOKEN',);
