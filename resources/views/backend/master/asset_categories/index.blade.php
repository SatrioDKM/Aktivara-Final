        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div id="api-success-message"
                        class="mb-4 p-4 bg-green-100 text-green-700 border border-green-300 rounded-lg"
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr x-show=" '{{ strtolower($category->name) }}'.includes(search.toLowerCase()) ">
                                    ...
                                    <td
                                        ...
                                        <!-- Button Edit -->
                                        <button
                                            @click="window.location.href='{{ route('master.asset_categories.edit', $category) }}'"
