<x-app-layout>
    ...
    <script>
        function roomForm(allFloors) {
                return {
                    isSubmitting: false,
                    formData: { id: null, name_room: '', floor_id: '', status: '', building_id: '' },
                    initData(room) {
                        this.formData = { ...room };
                        this.$nextTick(() => {
                            $('#building_id').val(room.floor.building_id).trigger('change');
                            this.updateFloorOptions(room.floor.building_id, room.floor_id);
                    ...
                    init() {
                        ...
                        $('#floor_id, #status').select2({ theme: "classic", width: '100%' });
                    },
                    ...
                    async saveRoom() {
                        ...
                        fetch(`/api/rooms/${this.formData.id}`, {
                            method: 'PUT',
