<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- Menu untuk Leader ke Atas (Laporan Masuk & Manajemen Tugas) --}}
                    ...
                    <div x-show="isOpen" @click.away="isOpen = false" x-transition
                        ...
                        <div class="py-1">
                            ...
                            <div class="max-h-80 overflow-y-auto">
                                ...
                                <template x-for="notification in unread" :key="notification.id"><a
                                ...
                                <template x-for="notification in read" :key="notification.id"><a
                                        :href="notification.data.url"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- Penambahan menu Laporan Masuk untuk Responsive --}}
            @if(in_array(Auth::user()->role_id, ['HK01', 'TK01', 'SC01', 'PK01', 'MG00', 'SA00']))
