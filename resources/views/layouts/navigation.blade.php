                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="left" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 focus:outline-none transition duration-150 ease-in-out {{ request()->routeIs('master.*', 'stock.index', 'packing_lists.index') ? 'border-indigo-400 dark:border-indigo-600 text-gray-900 dark:text-gray-100' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-700' }}">
                                    <div>Data Master</div>
                                    <div class="ms-1">
                                        <i class="fas fa-chevron-down h-4 w-4"></i>
                                    </div>
                            ...
                            <x-slot name="content">
                                <div class="px-4 py-2 text-xs text-gray-400">Bangunan</div>
                                <x-dropdown-link href="{{ route('master.buildings.index') }}" class="ps-6">{{
                                    __('Gedung') }}</x-dropdown-link>
                    ...
                    <x-nav-link :href="route('users.index')" :active="request()->routeIs('users.index')">{{__('Manajemen
                        Pengguna') }}</x-nav-link>
                    @endif
                    @endauth
                </div>
