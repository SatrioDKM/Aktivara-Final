            ...
            <div x-data="monitoringTasks()">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-700 mb-4">Daftar Tugas Sedang Dikerjakan</h3>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <template x-for="(task, index) in tasks" :key="task.id">
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-500"
                                                x-text="new Date(task.updated_at).toLocaleString('id-ID')"></td>
    ...
    <script>
        function monitoringTasks() {
            return {
                ...
                init() {
                    this.isLoading = true;
                    fetch('{{ route('api.tasks.in_progress_data') }}', {
